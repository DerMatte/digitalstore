...
const productsData: Product[] = [
  // we only have on user here
  {
    ...
    image:
      "https://user-images.githubusercontent.com/353959/66987533-40eae100-f0c1-11e9-822e-cbaf38fb8e3f.png",
    price: 20,
    available: true,
    slug: "casper",
  ...
  },
  {
    ...
    name: "Pico",
    description:
      "A minimal, functional **theme for Ghost**. Best suitable for running a paid-membership publication on Ghost - originally created by @pjrvs and @jackellis, acquired and stewarded by @tryghost in 2020. *Now available for free, for everyone!*",
    image:
      "https://user-images.githubusercontent.com/120485/70646878-67b93400-1c7a-11ea-9722-64bb7ecf2d22.png",
    price: 70,
    available: true,
    slug: "pico",
...
const main = async () => {
  ...
  for (const _product of productsData) {
    ...
    console.log(`Created Product with name: ${_product.name}`);
  }
